...
public class SysHomeController {
    ...
    public void home(HttpServletRequest req) {
        //SecurityUtils.getSubject().getSession().setTimeout(1000);
    		req.setAttribute("queueLength", OpDataBuffer.queueLength);
    		req.setAttribute("abortLength", OpDataBuffer.abortLength);
    		
    		req.setAttribute("oneTime", OpDataBuffer.oneTime);
    		req.setAttribute("twoTime", OpDataBuffer.twoTime);
    		req.setAttribute("threeTime", OpDataBuffer.threeTime);
    }
